...
public:
    ...
    QList< UI_User > getUsersList(); //start
...
public slots:
    ...
    void addScansToPatient(QStringList scanids, QString patientid);//choose patient
    void newPatientFromScans(QStringList scanids, UI_User user, QString comments);//choose patient
